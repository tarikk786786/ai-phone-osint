"""Phone utility functions — formatting, sanitization, validation helpers."""
...
def extract_country_code(phone: str) -> Optional[int]:
    """Try to extract country code from a phone number."""
...
def format_for_display(phone: str, default_country: Optional[str] = None) -> str:
...
# Map common country codes to ISO
COUNTRY_CODE_MAP: dict[int, str] = {
...
def get_country_iso_from_code(code: int) -> Optional[str]:
    """Get ISO country code from numeric country code."""
